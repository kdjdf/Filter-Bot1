...
if START_IMG is None:
    img = "https://telegra.ph/file/fc734b227985a1524hde715.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="⚙️Help",callback_data="help_back"),InlineKeyboardButton(text="",url="")]]
    keyboard += [[InlineKeyboardButton(text="", callback_data="main_connect"),InlineKeyboardButton(text="",url="t.me/{}?startgroup=true".format(bot.username))]]
